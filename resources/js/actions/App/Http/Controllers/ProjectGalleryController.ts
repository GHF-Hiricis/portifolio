...
/**
* @see \App\Http\Controllers\ProjectGalleryController::destroy
* @see app/Http/Controllers/ProjectGalleryController.php:11
* @route '/projectGallery/{image}'
*/
...
const ProjectGalleryController = { destroy }

export default ProjectGalleryController